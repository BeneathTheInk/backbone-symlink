(function(root, factory) {
	...
	// Set up Symlink appropriately for the environment. Start with AMD.
	...
	// finally just throw
		...
		throw new Error("Symlinks could not locate Backbone and/or Underscore.");
	}
	...
	// creates a set of method attached to a certain object
	...
	// restores previous Symlink if need be
